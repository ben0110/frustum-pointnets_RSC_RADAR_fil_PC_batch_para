...
TRAIN_DATASET = provider.RadarDataset_seg('pc_radar_2','KITTI',npoints=NUM_POINT, split='train',
...
TEST_1_DATASET =  provider.RadarDataset_seg('pc_radar_2','KITTI_2',npoints=NUM_POINT, split='test',rotate_to_center=False, one_hot=True,all_batches = True, translate_radar_center=False, store_data=True, proposals_3 =False ,no_color=True)
