...
TRAIN_DATASET = provider.RadarDataset_seg_cls('pc_radar_2','KITTI',npoints=NUM_POINT, split='train',
...
TEST_1_DATASET =  provider.RadarDataset_seg_cls('pc_radar_2','KITTI_2',npoints=NUM_POINT, split='test',rotate_to_center=False, one_hot=True,all_batches = True, translate_radar_center=False, store_data=True, proposals_3 =False ,no_color=True)
...
def save_data(src, segp_list, ids,ab_corners_list,ab_cls_list,ab_ids_list):
    output_filename = "/root/frustum-pointnets_RSC_RADAR_fil_PC_batch_para/dataset/RSC/seg_rois_" + src +"_1.pickle"
